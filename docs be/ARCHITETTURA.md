...
| `/api/v1/entity-definitions/**` | Solo ruolo di sistema `ADMIN` o `SUPER_ADMIN` |
| `/api/v1/groups/**` | Solo ruolo di sistema `ADMIN` o `SUPER_ADMIN` |
| `/api/v1/users/**` | Solo ruolo di sistema `ADMIN` o `SUPER_ADMIN` |
| `/api/v1/menu/manage/**` | Solo ruolo di sistema `ADMIN` o `SUPER_ADMIN` |
...
| `/api/v1/email/**` | Solo ruolo di sistema `ADMIN` o `SUPER_ADMIN` |
